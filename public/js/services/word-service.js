...
const getWords = async () => {
  const data =
    await window.appDataProvider.getState()
...
const createWord = async ({
  ...
  const folders =
    await window.folderService.getFolders()
  ...
  if (
    window.folderService.normalizeFolderType(targetFolder.type) !==
  ...
  await window.appDataProvider.updateState(
    (state) => {
